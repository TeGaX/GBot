...
#
RUN git clone -b staging https://github.com/zakaryan2004/GBot /root/userbot
...
#
COPY ./bla.txt ./userbot.session* ./config.env* ./client_secrets.json* ./secret.json* /root/userbot/
